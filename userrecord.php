                ...
                <table id="myTable">
                    ...
                    ?>
                            <tr>
                                ...
                                <td><?php echo $accessID ?></td>
                                <td><a href="newuseredit.php?id=<?php echo $username ?>" onclick="return confirm('Edit Information??')" >Edit</a>
                                <br><a href="delete.php?Del=<?php echo $username ?>" onclick="return confirm('Are you sure?')" >Delete</a>
                            </td>
                            </tr>        
                    <?php 
                                    }
