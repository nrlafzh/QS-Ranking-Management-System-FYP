        ...
        <div class="table" style="background-color: #fff; padding: 15px; margin-bottom: 10px; opacity: 0.9">
            <div style="overflow-x:auto;">
                ...
                <table id="myTable">
                    ...
                    ?>
                            <tr>
                                ...
                                <td><?php echo  $taraf ?></td>
                                <td><?php echo  $PTJ ?></td>
                                <td><a href="editstaff.php?id=<?php echo $namaStaff ?>">Edit</a>
                                <br><a href="deletestaff.php?Del=<?php echo $namaStaff ?>"onclick="return confirm('Are you sure?')">Delete</a>
                            </td>
                            </tr>        
                    <?php 
                                    }
                ...
                <div style= "background-color:#EFEEF1;padding:25px;">
                        ...
                        <form action="staffexcelhandling.php" method="POST">
