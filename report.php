...
$courseQuery = "SELECT DISTINCT course FROM students";
$courseResult = mysqli_query($conn, $courseQuery);

// Create an array to store the course names and their corresponding counts
$courseCounts = array();

while ($courseRow = mysqli_fetch_assoc($courseResult)) {
    $course = $courseRow['course'];
    $countQuery = "SELECT COUNT(*) as total FROM students WHERE course='$course'";
    $countResult = mysqli_query($conn, $countQuery);
    $countRow = mysqli_fetch_assoc($countResult);
    $count = $countRow['total'];
    
    // Store the course name and count in the array
        ...
        <div class="table" style="background-color: #fff; padding: 15px; margin-bottom: 10px; opacity: 0.9">
            <div style="overflow-x:auto;">
                <table id="myTable">
                    ...
                    <?php
                    // Iterate over the course counts array and display the course and count in each row
